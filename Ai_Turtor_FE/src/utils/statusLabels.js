const STATUS_META = Object.freeze({
  ...
  WAITING_FOR_MENTOR: { color: 'orange', label: 'Đang chờ giảng viên' },
  ...
  BASELINE_EXAMINED: { color: 'orange', label: 'AI trả lời · chưa gắn ý GV' },
  ...
  MENTOR_ANSWERED: { color: 'green', label: 'Giảng viên đã trả lời' },
  MENTOR_ANSWERED_PENDING_SENIOR_REVIEW: { color: 'purple', label: 'Đã trả lời · Chờ duyệt tri thức' },
  AI_BRAIN_UPDATED: { color: 'green', label: 'Đã cập nhật tri thức AI' },
  RESOLVED_INDEXED: { color: 'green', label: 'Đã cập nhật tri thức AI' },
  ANSWERED: { color: 'green', label: 'Giảng viên đã trả lời' },
  ANSWERED_KNOWLEDGE_REJECTED: { color: 'green', label: 'Giảng viên đã trả lời' },
