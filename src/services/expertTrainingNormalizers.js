...
export const normalizeCourseOption = (course = {}) => ({
  ...
  name: course.courseName || course.name || course.title || course.courseId || course.id || 'Course',
});
...
export const normalizeCoverageGap = (gap = {}) => ({
  ...
  chapter: gap.chapter || 'Unspecified chapter',
...
export const normalizeExpertTask = (task = {}) => ({
  ...
  chapter: task.chapter || 'Unspecified chapter',
  title: task.title || 'Expert contribution task',
...
export const normalizeGoldQa = (item = {}) => ({
  ...
  chapter: item.chapter || 'Unspecified chapter',
...
export const normalizeEvalRun = (run = {}) => ({
  ...
  chapter: run.chapter || 'All chapters',
