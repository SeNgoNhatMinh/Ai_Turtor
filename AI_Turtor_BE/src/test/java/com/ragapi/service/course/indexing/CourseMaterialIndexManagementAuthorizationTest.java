...
class CourseMaterialIndexManagementAuthorizationTest {

    private CourseMaterialStoreGateway repository;
    private CourseMaterialIndexGateway vectorService;
    private VisualVectorService visualVectorService;
    private CourseMaterialIndexManagementService service;

    @BeforeEach
    void setUp() {
        repository = mock(CourseMaterialStoreGateway.class);
        vectorService = mock(CourseMaterialIndexGateway.class);
        visualVectorService = mock(VisualVectorService.class);
        service = new CourseMaterialIndexManagementService(
                repository,
                vectorService,
                ...
                mock(HumanLearningService.class),
                mock(ExpertCoTrainingService.class),
                mock(CourseMaterialIndexExecutor.class)
        );
    }
