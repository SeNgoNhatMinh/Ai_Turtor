...
export const REALTIME_EVENT_TYPES = Object.freeze({
  ...
  liveLesson: ['LIVE_LESSON_SCHEDULED', 'LIVE_LESSON_STARTING', 'LIVE_LESSON_STARTED', 'LIVE_LESSON_ENDED'],
  ...
  expertTasks: ['EXPERT_TASK_CREATED', 'EXPERT_TASK_ASSIGNED', 'EXPERT_TASK_UPDATED', 'EXPERT_TASK_DELETED'],
  expertContributions: [
    'GOLD_QA_EXAMINED',
    'GOLD_QA_SUBMITTED',
    'GOLD_QA_APPROVED',
