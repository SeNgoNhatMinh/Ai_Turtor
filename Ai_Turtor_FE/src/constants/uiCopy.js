export const uiCopy = {
  ...
  student: {
    chat: {
      ...
      questionCounter: (count) => `Hôm nay ${count}/10`,
      almostFull: 'Còn vài câu hỏi nữa cho môn này hôm nay (10 câu/môn/ngày).',
      full: 'Môn này đã hết 10 câu hỏi hôm nay. Cảm ơn bạn đã học cùng mình.',
      sessionCompleteTitle: 'Phiên học hôm nay đã hết',
      sessionComplete: 'Cảm ơn bạn đã học cùng mình.',
      sessionCompleteHint: 'Mỗi môn được hỏi 10 câu mỗi ngày. Bạn có thể hỏi môn khác, hoặc quay lại môn này vào ngày mai.',
      ...
      newConversationTitle: 'Phiên học hôm nay đã kết thúc',
      rolloverMessage: 'Môn này đã hết 10 câu hỏi hôm nay. Cảm ơn bạn đã học cùng mình. Bạn có thể hỏi môn khác, hoặc quay lại vào ngày mai.',
