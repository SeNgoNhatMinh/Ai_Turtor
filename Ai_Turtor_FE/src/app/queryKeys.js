export const queryKeys = {
  ...
  expertCourses: (userId, mode) => ['expert-training', 'courses', userId || 'anonymous', mode],
  ...
  expertTaskMaterial: (courseId, chapter) => [
    'expert-training',
    courseId || 'none',
    'task-material',
    chapter || 'none',
  ],
  expertEvaluationDetail: (runId) => ['expert-training', 'evaluation-detail', runId || 'none'],
  ...
  teacherAnswerReviewQueue: (teacherId, role, courseId) => [
    'teacher',
    'review',
    'answer-queue',
    teacherId || 'anonymous',
  ...
  teacherResolvedAnswerReviews: (teacherId, courseId) => [
    'teacher',
    'review',
    'resolved',
    teacherId || 'anonymous',
  ...
  teacherKnowledgeCandidates: (teacherId, courseId, status) => [
    'teacher',
    'review',
