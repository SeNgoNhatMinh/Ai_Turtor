export const uiCopy = {
  ...
  student: {
    chat: {
      ...
      rolloverMessage:
        "Môn này đã hết 10 câu hỏi hôm nay. Cảm ơn bạn đã học cùng mình. Bạn có thể hỏi môn khác, hoặc quay lại vào ngày mai.",
    ...
    support: {
      ...
      emptyDescription:
        "Hãy đặt câu hỏi trong AI Tutor. Câu trả lời thiếu chắc chắn có thể được chuyển tới giảng viên tại đây.",
