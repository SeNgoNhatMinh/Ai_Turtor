...
public class ApprovedKnowledgeSearchService {
    ...
    public List<RetrievedCourseChunk> retrieveRelevant(
        ...
        List<RetrievedCourseChunk> lexicalCandidates =
        ...
        Map<String, RetrievedCourseChunk> candidatesByKey = new LinkedHashMap<>();
        for (RetrievedCourseChunk candidate : lexicalCandidates) {
            candidatesByKey.put(chunkKey(candidate), candidate);
        }
        for (RetrievedCourseChunk candidate : semanticCandidates) {
     ...
     */
    private List<RetrievedCourseChunk> collapseDuplicateQuestions(
            List<RetrievedCourseChunk> matches
    ) {
        Map<String, RetrievedCourseChunk> byMaterial = new LinkedHashMap<>();
        for (RetrievedCourseChunk chunk : matches) {
    ...
    private boolean isRelevant(String question, RetrievedCourseChunk chunk) {
