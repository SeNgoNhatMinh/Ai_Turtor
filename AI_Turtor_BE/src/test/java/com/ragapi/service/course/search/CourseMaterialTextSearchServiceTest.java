...
class CourseMaterialTextSearchServiceTest {

    @Mock CourseMaterialStoreGateway materialRepository;
    CourseMaterialTextSearchService service;

    @org.junit.jupiter.api.BeforeEach
    void setUp() {
        service = new CourseMaterialTextSearchService(materialRepository, new CourseMaterialChunkingService());
    }
    ...
    void textbookSearchExcludesV1CandidatesAndGoldQa() {
        ...
        List<RetrievedCourseChunk> result = service.searchTextbook(
                "recursion",
                "PFP191",
                null,
                8
    ...
    void approvedKnowledgeSearchMatchesConceptInsideFullAnswerOnly() {
        ...
        List<RetrievedCourseChunk> result = service.searchApprovedKnowledge(
                "Forward Propagation",
                "PFP191",
                null,
                8
